...
class Review(models.Model):
    shop_link = models.CharField(max_length=50, verbose_name='Shop link')
    user_mail = models.EmailField(max_length=50, verbose_name='User email')
    ...
    review_dt = models.DateTimeField(auto_now_add=True, verbose_name='Review created at')
